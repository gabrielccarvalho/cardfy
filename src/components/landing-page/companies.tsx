...
import { UFRN, UniFacex } from '../icons'
	...
	return (
		<div className='my-10 mx-auto w-full'>
			...
			<Link
				...
				href='/'
			>
				<UFRN className='max-w-52 blur-0 grayscale transition-all hover:grayscale-0 md:h-20' />
				<UniFacex className='h-20 blur-0 grayscale transition-all hover:grayscale-0' />
			</Link>
		</div>
	)
}
